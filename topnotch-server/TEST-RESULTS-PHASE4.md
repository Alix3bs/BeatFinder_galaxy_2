...
Run: 2026-07-07T14:36:24.750Z · fresh staging database

| # | Scenario | Result | Detail |
|---|----------|--------|--------|
| 1 | Consent required, versioned and recorded (no pre-checked boxes) | ✅ PASS | TN-260707-F8CDA3 |
...
| 7 | Encrypted backup + tested restore + dashboard status | ✅ PASS | topnotch-2026-07-07-14-36.db.enc → restored, 8 users readable |
