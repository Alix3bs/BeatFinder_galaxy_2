...
Run: 2026-07-13T06:12:40.752Z · fresh staging database

| # | Scenario | Result | Detail |
|---|----------|--------|--------|
| 1 | Consent required, versioned and recorded (no pre-checked boxes) | ✅ PASS | TN-260713-9E47E2 |
...
| 7 | Encrypted backup + tested restore + dashboard status | ✅ PASS | topnotch-2026-07-13-06-12.db.enc → restored, 8 users readable |
