...
Run: 2026-07-11T21:27:51.490Z · fresh staging database

| # | Scenario | Result | Detail |
|---|----------|--------|--------|
| 1 | Consent required, versioned and recorded (no pre-checked boxes) | ✅ PASS | TN-260711-A44C74 |
...
| 7 | Encrypted backup + tested restore + dashboard status | ✅ PASS | topnotch-2026-07-11-21-27.db.enc → restored, 8 users readable |
