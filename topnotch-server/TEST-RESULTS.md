...
Run: 2026-07-07T14:38:21.743Z · Node v22.22.2 · fresh database per run

| # | Scenario | Result | Detail |
|---|----------|--------|--------|
| 1 | Customer submits a valid request | ✅ PASS | TN-260707-8DABE3 |
| 2 | Duplicate request is detected | ✅ PASS | flagged as dup of TN-260707-8DABE3 |
...
| 9 | Vehicle becomes booked after payment confirmation | ✅ PASS | AR-260707-8DABE3 |
| 10 | Overlapping booking is blocked | ✅ PASS | assign V-1002 for 08/11–08/13 → 409 |
| 11 | Active rental is completed | ✅ PASS | AR-260707-8DABE3 (checklists enforced) |
...
| B2 | Browser: full booking wizard submits through the API | ✅ PASS | TN-260707-66E812 |
